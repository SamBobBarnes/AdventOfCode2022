...
class Monkey2
{
    ...
    public void TakeItems(List<SudoNumber> items)
    {
...
class Operation2
{
    ...
    public SudoNumber Act(SudoNumber old)
    {
        if (_actWith < 0)
        {
            SudoNumber actWith = old;
